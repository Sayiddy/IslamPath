...
export default function Footer() {
  return(
    <div className="relative overflow-hidden h-[550px] w-full bg-cDarkerGreen text-center text-white flex flex-row justify-center items-center text-[18px] gap-20">
