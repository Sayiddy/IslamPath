...
export default function Footer() {
  return(
    <div className="relative overflow-hidden h-[550px] w-full bg-[#00642E] text-center text-white flex flex-row justify-center items-center text-[18px] gap-20">
      ...
      <div className="flex flex-col z-10">
        ...
        <div className='flex flex-col gap-2'>
          <div className='flex gap-3 items-center'>
            <AiFillMail className='fill-[#FCCD2A] text-2xl'/>
            <p className='font-semibold'>Islampathacademy@gmail.com</p>
          </div>
          <div className='flex gap-3 items-center'>
            <BsTelephoneFill className='fill-[#FCCD2A] text-2xl'/>
            <p className='font-semibold'>+201095283906</p>
          </div>
          <div className='flex gap-3 items-center'>
            <RiWhatsappFill className='fill-[#FCCD2A] text-2xl'/>
            <p className='font-semibold'>+201095283906</p>
          </div>
        </div>
        <h2 className="font-bold text-4xl mt-5 text-left">Social Media</h2>
        <hr className="w-full border-t-2 border-white my-4"/>
        <div className='flex flex-row items-center text-2xl gap-4 fill-[#FCCD2A]'>
          <BsYoutube className='fill-[#FCCD2A]'/>
          <BsFacebook className='fill-[#FCCD2A]'/>
          <AiFillInstagram className='fill-[#FCCD2A]'/>
          <AiFillTwitterCircle className='fill-[#FCCD2A]'/>
        </div>
      </div>
    </div>
  )
