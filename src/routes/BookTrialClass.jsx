...
export default function BookTrialClass() {
  ...
  return (
    <>
      ...
      <div className="bg-white rounded-2xl w-3/4 my-[82px] text-center mx-auto p-16 shadow-[0px_0px_20px_2px_rgba(0,0,0,0.25)] font-sans">
        ...
        <form className="grid grid-cols-2 grid-rows-1 gap-10 text-left" onSubmit={sendEmail} ref={ref}>
          ...
          <input type="submit" value="Book Trial Class" className="col-span-2 bg-cBronze hover:bg-transparent border-3 border-transparent hover:border-cYellow hover:text-cBlack text-white text-[20px] rounded-[15px] px-6 py-3 mt-4 mx-auto cursor-pointer transition-all duration-300"/>
        </form>
      </div>
    </>
  )
